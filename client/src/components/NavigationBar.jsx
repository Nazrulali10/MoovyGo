    ...
    <div>
      <nav className="relative bg-white dark:bg-neutral-950 shadow w-full h-18 flex flex-row-reverse justify-between px-5 md:px-30 items-center">
        <div className="flex items-center gap-4">
          <Link to="/">
            <div className="bg-white rounded-full">
              <img
                className="h-8 md:h-9 object-contain p-1 md:p-1"
                src="/icon.png"
                alt="icon"
              />
            </div>
        ...
        <div className="flex items-center md:gap-0 gap-2">
          <div onClick={()=>setIsMenuopen(!isMenuopen)} className="dark:text-white text-gray-500 md:hidden flex" >
            <EllipsisVertical />
          </div>
      ...
      <div className={`md:hidden fixed h-screen w-full dark:bg-neutral-950 bg-white z-30 transition-all px-8 py-8  gap-3 duration-500 transform ${isMenuopen?'translate-x-0':'-translate-x-full'}`}>
        <div className="flex flex-col gap-4">
          <Link to="/">
            <div className="bg-white rounded-full w-30 mb-2">
              <img
                className="h-10 object-contain p-1 md:p-1"
                src="/icon.png"
                alt="icon"
              />
            </div>
        ...
        <div className="flex w-full items-center gap-1">
          <p className="flex text-sm dark:text-white text-black">Switch theme</p>
        <ToggleTheme/>
        </div>
